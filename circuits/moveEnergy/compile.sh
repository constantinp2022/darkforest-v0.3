...
rm -rf ../../client/public/circuits/moveEnergy/ &&
mkdir -p ../../client/public/circuits/moveEnergy/ &&
cp circuit.json ../../client/public/circuits/moveEnergy/ &&
...
rm ../../mockchain/public/snark/moveEnergy/verification_key.json
mkdir -p ../../mockchain/public/snark/moveEnergy/
cp ./verification_key.json ../../mockchain/public/snark/moveEnergy/verification_key.json
echo "done!" &&
date
